              ...
              {navLinks.map((item) => {
                ...
                return (
                  ...
                  >
                    <Link 
                      href={item.link} 
                      className={`flex items-center gap-2 text-[15px] font-semibold transition-colors duration-200 cursor-pointer ${
                        isActive ? "text-[#6C47FF]" : "text-[#222] hover:text-[#6C47FF]"
                      }`}
                    >
                      {item.name}
                      {item.name === "Games" && (
